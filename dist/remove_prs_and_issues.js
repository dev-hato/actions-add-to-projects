...
var require_typeComparators = __commonJS({
  "node_modules/graphql/utilities/typeComparators.js"(exports2) {
    ...
    function isTypeSubTypeOf(schema3, maybeSubType, superType) {
      ...
      return (0, _definition.isAbstractType)(superType) && ((0, _definition.isInterfaceType)(maybeSubType) || (0, _definition.isObjectType)(maybeSubType)) && schema3.isSubType(superType, maybeSubType);
    }
...
var require_schema = __commonJS({
  "node_modules/graphql/type/schema.js"(exports2) {
    ...
    function isSchema(schema3) {
      return (0, _instanceOf.instanceOf)(schema3, GraphQLSchema);
    }
    function assertSchema(schema3) {
      if (!isSchema(schema3)) {
        throw new Error(
          `Expected ${(0, _inspect.inspect)(schema3)} to be a GraphQL schema.`
        );
      }
      return schema3;
    }
...
var require_validate = __commonJS({
  "node_modules/graphql/type/validate.js"(exports2) {
    ...
    function validateSchema(schema3) {
      (0, _schema.assertSchema)(schema3);
...
var require_TypeInfo = __commonJS({
  "node_modules/graphql/utilities/TypeInfo.js"(exports2) {
      ...
      enter(node) {
        ...
        switch (node.kind) {
          ...
          case _kinds.Kind.FRAGMENT_DEFINITION: {
            ...
            const outputType = typeConditionAST ? (0, _typeFromAST.typeFromAST)(schema3, typeConditionAST) : (0, _definition.getNamedType)(this.getType());
            this._typeStack.push(
          ...
          case _kinds.Kind.VARIABLE_DEFINITION: {
            const inputType = (0, _typeFromAST.typeFromAST)(schema3, node.type);
    ...
    function getFieldDef(schema3, parentType, fieldNode) {
      ...
      if (name === _introspection.SchemaMetaFieldDef.name && schema3.getQueryType() === parentType) {
        return _introspection.SchemaMetaFieldDef;
      }
      if (name === _introspection.TypeMetaFieldDef.name && schema3.getQueryType() === parentType) {
  ...
  "node_modules/graphql/validation/rules/FieldsOnCorrectTypeRule.js"(exports2) {
    ...
    function getSuggestedTypeNames(schema3, type, fieldName) {
      ...
      return [...suggestedTypes].sort((typeA, typeB) => {
        ...
        if ((0, _definition.isInterfaceType)(typeA) && schema3.isSubType(typeA, typeB)) {
          return -1;
        }
        if ((0, _definition.isInterfaceType)(typeB) && schema3.isSubType(typeB, typeA)) {
          return 1;
        }
...
var require_KnownArgumentNamesRule = __commonJS({
  "node_modules/graphql/validation/rules/KnownArgumentNamesRule.js"(exports2) {
    ...
    function KnownArgumentNamesOnDirectivesRule(context) {
      ...
      const schema3 = context.getSchema();
      const definedDirectives = schema3 ? schema3.getDirectives() : _directives.specifiedDirectives;
...
var require_ProvidedRequiredArgumentsRule = __commonJS({
  "node_modules/graphql/validation/rules/ProvidedRequiredArgumentsRule.js"(exports2) {
    ...
    function ProvidedRequiredArgumentsOnDirectivesRule(context) {
      ...
      const schema3 = context.getSchema();
      const definedDirectives = (_schema$getDirectives = schema3 === null || schema3 === void 0 ? void 0 : schema3.getDirectives()) !== null && _schema$getDirectives !== void 0 ? _schema$getDirectives : _directives.specifiedDirectives;
      for (const directive of definedDirectives) {
  ...
  "node_modules/graphql/execution/values.js"(exports2) {
    ...
    function coerceVariableValues(schema3, varDefNodes, inputs, onError) {
      ...
      for (const varDefNode of varDefNodes) {
        ...
        const varType = (0, _typeFromAST.typeFromAST)(schema3, varDefNode.type);
...
var require_VariablesInAllowedPositionRule = __commonJS({
  "node_modules/graphql/validation/rules/VariablesInAllowedPositionRule.js"(exports2) {
        ...
        OperationDefinition: {
          ...
          leave(operation) {
            ...
            for (const { node, type, defaultValue } of usages) {
              ...
              if (varDef && type) {
                const schema3 = context.getSchema();
                const varType = (0, _typeFromAST.typeFromAST)(schema3, varDef.type);
    ...
    function allowedVariableUsage(schema3, varType, varDefaultValue, locationType, locationDefaultValue) {
      ...
      return (0, _typeComparators.isTypeSubTypeOf)(schema3, varType, locationType);
    }
  }
});
...
var require_validate2 = __commonJS({
  "node_modules/graphql/validation/validate.js"(exports2) {
    ...
    function validate2(schema3, documentAST, rules = _specifiedRules.specifiedRules, options, typeInfo = new _TypeInfo.TypeInfo(schema3)) {
      var _options$maxErrors;
      const maxErrors = (_options$maxErrors = options === null || options === void 0 ? void 0 : options.maxErrors) !== null && _options$maxErrors !== void 0 ? _options$maxErrors : 100;
      documentAST || (0, _devAssert.devAssert)(false, "Must provide document.");
      (0, _validate.assertValidSchema)(schema3);
    ...
    function assertValidSDLExtension(documentAST, schema3) {
      const errors = validateSDL(documentAST, schema3);
      if (errors.length !== 0) {
        throw new Error(errors.map((error) => error.message).join("\n\n"));
      }
    }
...
var require_execute = __commonJS({
  "node_modules/graphql/execution/execute.js"(exports2) {
    ...
    function execute(args) {
      ...
      const { schema: schema3, document, variableValues, rootValue } = args;
      assertValidExecutionArguments(schema3, document, variableValues);
    ...
    function assertValidExecutionArguments(schema3, document, rawVariableValues) {
    ...
    function getFieldDef(schema3, parentType, fieldNode) {
      ...
      if (fieldName === _introspection.SchemaMetaFieldDef.name && schema3.getQueryType() === parentType) {
        return _introspection.SchemaMetaFieldDef;
      } else if (fieldName === _introspection.TypeMetaFieldDef.name && schema3.getQueryType() === parentType) {
        return _introspection.TypeMetaFieldDef;
...
var require_graphql = __commonJS({
  "node_modules/graphql/graphql.js"(exports2) {
    ...
    function graphqlImpl(args) {
      ...
      const schemaValidationErrors = (0, _validate.validateSchema)(schema3);
      ...
      const validationErrors = (0, _validate2.validate)(schema3, document);
...
var require_subscribe = __commonJS({
  "node_modules/graphql/execution/subscribe.js"(exports2) {
    ...
    async function createSourceEventStream(...rawArgs) {
      ...
      const { schema: schema3, document, variableValues } = args;
      (0, _execute.assertValidExecutionArguments)(schema3, document, variableValues);
    ...
    async function executeSubscription(exeContext) {
      ...
      const fieldDef = (0, _execute.getFieldDef)(schema3, rootType, fieldNodes[0]);
      if (!fieldDef) {
...
var require_getOperationRootType = __commonJS({
  "node_modules/graphql/utilities/getOperationRootType.js"(exports2) {
    ...
    var _GraphQLError = require_GraphQLError();
    function getOperationRootType(schema3, operation) {
  ...
  "node_modules/graphql/utilities/extendSchema.js"(exports2) {
    ...
    function extendSchema(schema3, documentAST, options) {
      ...
      if ((options === null || options === void 0 ? void 0 : options.assumeValid) !== true && (options === null || options === void 0 ? void 0 : options.assumeValidSDL) !== true) {
        (0, _validate.assertValidSDLExtension)(documentAST, schema3);
      }
      const schemaConfig = schema3.toConfig();
      const extendedConfig = extendSchemaImpl(schemaConfig, documentAST, options);
      return schemaConfig === extendedConfig ? schema3 : new _schema.GraphQLSchema(extendedConfig);
    }
...
var require_printSchema = __commonJS({
  "node_modules/graphql/utilities/printSchema.js"(exports2) {
    ...
    function printIntrospectionSchema(schema3) {
      return printFilteredSchema(
        schema3,
    ...
    function printFilteredSchema(schema3, directiveFilter, typeFilter) {
...
var require_graphql_tag_umd = __commonJS({
  "node_modules/graphql-tag/lib/graphql-tag.umd.js"(exports2, module2) {
    (function(global, factory) {
      typeof exports2 === "object" && typeof module2 !== "undefined" ? factory(exports2, (init_tslib_es6(), __toCommonJS(tslib_es6_exports)), require_graphql2()) : typeof define === "function" && define.amd ? define(["exports", "tslib", "graphql"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["graphql-tag"] = {}, global.tslib, global.graphql));
...
// node_modules/@octokit/graphql-schema/index.js
var import_node_fs2 = require("node:fs");

// node_modules/@octokit/graphql-schema/lib/validate.js
var import_node_fs = require("node:fs");
var import_graphql = __toESM(require_graphql2(), 1);
var import_graphql_tag = __toESM(require_main(), 1);
var import_meta = {};
var validate_default = validateQuery;
var schema = (0, import_graphql.buildClientSchema)(
  JSON.parse((0, import_node_fs.readFileSync)(new URL("../schema.json", import_meta.url), "utf8"))
);
function validateQuery(query) {
  return (0, import_graphql.validate)(schema, (0, import_graphql_tag.default)(query));
}
...
var schema2 = {
  get idl() {
    return (0, import_node_fs2.readFileSync)(new URL("./schema.graphql", import_meta2.url), "utf8");
  },
  json: JSON.parse((0, import_node_fs2.readFileSync)(new URL("./schema.json", import_meta2.url), "utf8"))
};
...
async function script(github) {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    const getProjectV2ItemsQueryErrors = validate_default(getProjectV2ItemsQuery);
    ...
    for (const item of nodes) {
      ...
      const deleteItemFromProjectQueryErrors = validate_default(
